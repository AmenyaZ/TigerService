...
public class WorkerDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_name = findViewById(R.id.tv_detailWorkName);
        tv_location = findViewById(R.id.tv_detailWorkLocation);
        tv_speciality = findViewById(R.id.tv_detailWorkSpeciality);
        tv_mail = findViewById(R.id.tv_detailEmail);
        tv_phone = findViewById(R.id.tv_detailWorkPhone);
        mechanicImage = findViewById(R.id.detailWorkImage);
...
//                Permission Already Granted
    ...
    private void requestPermission() {
        ActivityCompat.requestPermissions(WorkerDetails.this, new String[]{Manifest.permission.CALL_PHONE}, CALL_PERMISSION);
